...
class AddActivityAndStudentView(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets={
            ...
            'manifestacion_festivales': forms.TextInput(attrs={'class': 'form-control', 'pattern':"^[A-Z][a-z]*$", 'title':"Se espera que el nombre sean letras y comiencen con mayúscula", 'placeholder':"Escribe una manifestacion"}),
            ...
            'actividades_participacion_actos_matutinos':forms.Textarea(attrs={'class':'form-control', 'placeholder':"Escribe actos y matutinos que hallas participado."}),
